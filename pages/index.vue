  ...
  <div>
    <div class="container mb-5">
      ...
      <div :class="{ 'hidden-content': true, hidden: !isClicked }">
        <div class="meeter mt-5">
          <h1>Oh okay, you got me!</h1>
          <h4>Take this video as easter egg</h4>
          <iframe
            width="80%"
            height="450px"
...
export default {
  ...
  methods: {
    toggleClicked() {
      ...
      this.isClicked = true;
      let hidden = this.$el.querySelector(".hidden-content");
      setTimeout(() => {
